...
uint8_t plc4c_plc4x_read_write_plc4x_return_code_get_value(plc4c_plc4x_read_write_plc4x_return_code value) {
    switch(value) {
        case plc4c_plc4x_read_write_plc4x_return_code_OK:
            return (uint8_t) 0x01;
        case plc4c_plc4x_read_write_plc4x_return_code_NOT_FOUND:
            return (uint8_t) 0x02;
        case plc4c_plc4x_read_write_plc4x_return_code_ACCESS_DENIED:
            return (uint8_t) 0x03;
        case plc4c_plc4x_read_write_plc4x_return_code_INVALID_ADDRESS:
            return (uint8_t) 0x04;
        case plc4c_plc4x_read_write_plc4x_return_code_INVALID_DATATYPE:
            return (uint8_t) 0x05;
        case plc4c_plc4x_read_write_plc4x_return_code_INVALID_DATA:
            return (uint8_t) 0x06;
        case plc4c_plc4x_read_write_plc4x_return_code_INTERNAL_ERROR:
            return (uint8_t) 0x07;
        case plc4c_plc4x_read_write_plc4x_return_code_REMOTE_BUSY:
            return (uint8_t) 0x08;
        case plc4c_plc4x_read_write_plc4x_return_code_REMOTE_ERROR:
            return (uint8_t) 0x09;
        case plc4c_plc4x_read_write_plc4x_return_code_UNSUPPORTED:
            return (uint8_t) 0x0A;
        case plc4c_plc4x_read_write_plc4x_return_code_RESPONSE_PENDING:
            return (uint8_t) 0x0B;
    }
    return 0;
}
...
plc4c_return_code plc4c_plc4x_read_write_plc4x_return_code_serialize(plc4c_spi_write_buffer* writeBuffer, plc4c_plc4x_read_write_plc4x_return_code* _message) {
    ...
    uint8_t value = plc4c_plc4x_read_write_plc4x_return_code_get_value(*_message);

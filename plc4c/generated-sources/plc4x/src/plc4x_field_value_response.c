...
#include "plc4x_field_value_response.h"

// Code generated by code-generation. DO NOT EDIT.


// Parse function.
plc4c_return_code plc4c_plc4x_read_write_plc4x_field_value_response_parse(plc4c_spi_read_buffer* readBuffer, plc4c_plc4x_read_write_plc4x_field_value_response** _message) {
  uint16_t startPos = plc4c_spi_read_get_pos(readBuffer);
  plc4c_return_code _res = OK;

  // Allocate enough memory to contain this data structure.
  (*_message) = malloc(sizeof(plc4c_plc4x_read_write_plc4x_field_value_response));
  if(*_message == NULL) {
    return NO_MEMORY;
  }
...
plc4c_return_code plc4c_plc4x_read_write_plc4x_field_value_response_serialize(plc4c_spi_write_buffer* writeBuffer, plc4c_plc4x_read_write_plc4x_field_value_response* _message) {
  plc4c_return_code _res = OK;
...
uint16_t plc4c_plc4x_read_write_plc4x_field_value_response_length_in_bytes(plc4c_plc4x_read_write_plc4x_field_value_response* _message) {
  return plc4c_plc4x_read_write_plc4x_field_value_response_length_in_bits(_message) / 8;
}

uint16_t plc4c_plc4x_read_write_plc4x_field_value_response_length_in_bits(plc4c_plc4x_read_write_plc4x_field_value_response* _message) {

...
plc4c_return_code plc4c_plc4x_read_write_plc4x_message_parse(plc4c_spi_read_buffer* readBuffer, plc4c_plc4x_read_write_plc4x_message** _message) {
  ...
  uint8_t requestType_raw_value;
  _res = plc4c_spi_read_unsigned_byte(readBuffer, 8, (uint8_t*) &requestType_raw_value);
  requestType = plc4c_plc4x_read_write_plc4x_request_type_for_value(requestType_raw_value);
  if(_res != OK) {
    return _res;
  }
...
plc4c_return_code plc4c_plc4x_read_write_plc4x_message_serialize(plc4c_spi_write_buffer* writeBuffer, plc4c_plc4x_read_write_plc4x_message* _message) {
  ...
  // Const Field (version)
  uint8_t version = PLC4C_PLC4X_READ_WRITE_PLC4X_MESSAGE_VERSION();
  plc4c_spi_write_unsigned_byte(writeBuffer, 8, version);

  // Implicit Field (packetLength) (Used for parsing, but its value is not stored as it's implicitly given by the objects content)
  uint16_t packetLength = plc4c_plc4x_read_write_plc4x_message_length_in_bytes(_message);
  _res = plc4c_spi_write_unsigned_short(writeBuffer, 16, packetLength);
  if(_res != OK) {
    return _res;
  }

  // Simple Field (requestId)
  uint16_t requestId = _message->request_id;
  _res = plc4c_spi_write_unsigned_short(writeBuffer, 16, requestId);
  if(_res != OK) {
    return _res;
  }

  // Enumerated Discriminator Field (requestType)
  plc4c_plc4x_read_write_plc4x_request_type requestType = plc4c_plc4x_read_write_plc4x_message_get_discriminator(_message->_type).requestType;
  plc4c_plc4x_read_write_plc4x_request_type_serialize(writeBuffer, &requestType);
  ...
  // Implicit Field (connectionStringLen) (Used for parsing, but its value is not stored as it's implicitly given by the objects content)
  uint8_t connectionStringLen = plc4c_spi_evaluation_helper_str_len(_message->plc4x_connect_request_connection_string);
  _res = plc4c_spi_write_unsigned_byte(writeBuffer, 8, connectionStringLen);
  if(_res != OK) {
    return _res;
  }

  // Simple Field (connectionString)
  char* connectionString = _message->plc4x_connect_request_connection_string;
  _res = plc4c_spi_write_string(writeBuffer, (connectionStringLen) * (8), "UTF-8", connectionString);
  if(_res != OK) {
    return _res;
  }
  ...
  // Simple Field (connectionId)
  uint16_t connectionId = _message->plc4x_connect_response_connection_id;
  _res = plc4c_spi_write_unsigned_short(writeBuffer, 16, connectionId);
  if(_res != OK) {
    return _res;
  }

  // Simple Field (responseCode)
  plc4c_plc4x_read_write_plc4x_response_code responseCode = _message->plc4x_connect_response_response_code;
  ...
  // Simple Field (connectionId)
  uint16_t connectionId = _message->plc4x_read_request_connection_id;
  _res = plc4c_spi_write_unsigned_short(writeBuffer, 16, connectionId);
  if(_res != OK) {
    return _res;
  }
  ...
  // Implicit Field (numFields) (Used for parsing, but its value is not stored as it's implicitly given by the objects content)
  uint8_t numFields = plc4c_spi_evaluation_helper_count(_message->plc4x_read_request_fields);
  _res = plc4c_spi_write_unsigned_byte(writeBuffer, 8, numFields);
  if(_res != OK) {
    return _res;
  }
  ...
  // Simple Field (connectionId)
  uint16_t connectionId = _message->plc4x_read_response_connection_id;
  _res = plc4c_spi_write_unsigned_short(writeBuffer, 16, connectionId);
  if(_res != OK) {
    return _res;
  }
  ...
  // Simple Field (responseCode)
  plc4c_plc4x_read_write_plc4x_response_code responseCode = _message->plc4x_read_response_response_code;
  _res = plc4c_plc4x_read_write_plc4x_response_code_serialize(writeBuffer, &responseCode);
  if(_res != OK) {
    return _res;
  }
  ...
  // Implicit Field (numFields) (Used for parsing, but its value is not stored as it's implicitly given by the objects content)
  uint8_t numFields = plc4c_spi_evaluation_helper_count(_message->plc4x_read_response_fields);
  _res = plc4c_spi_write_unsigned_byte(writeBuffer, 8, numFields);
  if(_res != OK) {
    return _res;
  }
  ...
  // Simple Field (connectionId)
  uint16_t connectionId = _message->plc4x_write_request_connection_id;
  _res = plc4c_spi_write_unsigned_short(writeBuffer, 16, connectionId);
  if(_res != OK) {
    return _res;
  }
  ...
  // Implicit Field (numFields) (Used for parsing, but its value is not stored as it's implicitly given by the objects content)
  uint8_t numFields = plc4c_spi_evaluation_helper_count(_message->plc4x_write_request_fields);
  _res = plc4c_spi_write_unsigned_byte(writeBuffer, 8, numFields);
  if(_res != OK) {
    return _res;
  }
  ...
  // Simple Field (connectionId)
  uint16_t connectionId = _message->plc4x_write_response_connection_id;
  _res = plc4c_spi_write_unsigned_short(writeBuffer, 16, connectionId);
  if(_res != OK) {
    return _res;
  }
  ...
  // Simple Field (responseCode)
  plc4c_plc4x_read_write_plc4x_response_code responseCode = _message->plc4x_write_response_response_code;
  _res = plc4c_plc4x_read_write_plc4x_response_code_serialize(writeBuffer, &responseCode);
  if(_res != OK) {
    return _res;
  }
  ...
  // Implicit Field (numFields) (Used for parsing, but its value is not stored as it's implicitly given by the objects content)
  uint8_t numFields = plc4c_spi_evaluation_helper_count(_message->plc4x_write_response_fields);
  _res = plc4c_spi_write_unsigned_byte(writeBuffer, 8, numFields);
  if(_res != OK) {
    return _res;
  }

...
uint16_t plc4c_modbus_read_write_data_item_length_in_bytes(plc4c_data* _value, plc4c_modbus_read_write_modbus_data_type dataType, uint16_t numberOfValues) {
  return plc4c_modbus_read_write_data_item_length_in_bits(_value, dataType, numberOfValues) / 8;
}

uint16_t plc4c_modbus_read_write_data_item_length_in_bits(plc4c_data* _value, plc4c_modbus_read_write_modbus_data_type dataType, uint16_t numberOfValues) {

...
plc4c_return_code plc4c_modbus_read_write_modbus_pdu_serialize(plc4c_spi_write_buffer* writeBuffer, plc4c_modbus_read_write_modbus_pdu* _message) {
  ...
  // Discriminator Field (errorFlag)
  bool errorFlag = plc4c_modbus_read_write_modbus_pdu_get_discriminator(_message->_type).errorFlag;
  plc4c_spi_write_bit(writeBuffer, errorFlag);

  // Discriminator Field (functionFlag)
  uint8_t functionFlag = plc4c_modbus_read_write_modbus_pdu_get_discriminator(_message->_type).functionFlag;
  plc4c_spi_write_unsigned_byte(writeBuffer, 7, functionFlag);
  ...
  // Simple Field (exceptionCode)
  plc4c_modbus_read_write_modbus_error_code exceptionCode = _message->modbus_pdu_error_exception_code;
  _res = plc4c_modbus_read_write_modbus_error_code_serialize(writeBuffer, &exceptionCode);
  if(_res != OK) {
    return _res;
  }
  ...
  // Simple Field (startingAddress)
  uint16_t startingAddress = _message->modbus_pdu_read_discrete_inputs_request_starting_address;
  _res = plc4c_spi_write_unsigned_short(writeBuffer, 16, startingAddress);
  if(_res != OK) {
    return _res;
  }

  // Simple Field (quantity)
  uint16_t quantity = _message->modbus_pdu_read_discrete_inputs_request_quantity;
  _res = plc4c_spi_write_unsigned_short(writeBuffer, 16, quantity);
  if(_res != OK) {
    return _res;
  }
  ...
  // Implicit Field (byteCount) (Used for parsing, but its value is not stored as it's implicitly given by the objects content)
  uint8_t byteCount = plc4c_spi_evaluation_helper_count(_message->modbus_pdu_read_discrete_inputs_response_value);
  _res = plc4c_spi_write_unsigned_byte(writeBuffer, 8, byteCount);
  if(_res != OK) {
    return _res;
  }
  ...
  // Simple Field (startingAddress)
  uint16_t startingAddress = _message->modbus_pdu_read_coils_request_starting_address;
  _res = plc4c_spi_write_unsigned_short(writeBuffer, 16, startingAddress);
  if(_res != OK) {
    return _res;
  }
  ...
  // Simple Field (quantity)
  uint16_t quantity = _message->modbus_pdu_read_coils_request_quantity;
  _res = plc4c_spi_write_unsigned_short(writeBuffer, 16, quantity);
  if(_res != OK) {
    return _res;
  }
  ...
  // Implicit Field (byteCount) (Used for parsing, but its value is not stored as it's implicitly given by the objects content)
  uint8_t byteCount = plc4c_spi_evaluation_helper_count(_message->modbus_pdu_read_coils_response_value);
  _res = plc4c_spi_write_unsigned_byte(writeBuffer, 8, byteCount);
  if(_res != OK) {
    return _res;
  }
  ...
  // Simple Field (address)
  uint16_t address = _message->modbus_pdu_write_single_coil_request_address;
  _res = plc4c_spi_write_unsigned_short(writeBuffer, 16, address);
  if(_res != OK) {
    return _res;
  }

  // Simple Field (value)
  uint16_t value = _message->modbus_pdu_write_single_coil_request_value;
  _res = plc4c_spi_write_unsigned_short(writeBuffer, 16, value);
  if(_res != OK) {
    return _res;
  }
  ...
  // Simple Field (address)
  uint16_t address = _message->modbus_pdu_write_single_coil_response_address;
  _res = plc4c_spi_write_unsigned_short(writeBuffer, 16, address);
  if(_res != OK) {
    return _res;
  }
  ...
  // Simple Field (value)
  uint16_t value = _message->modbus_pdu_write_single_coil_response_value;
  _res = plc4c_spi_write_unsigned_short(writeBuffer, 16, value);
  if(_res != OK) {
    return _res;
  }
  ...
  // Simple Field (startingAddress)
  uint16_t startingAddress = _message->modbus_pdu_write_multiple_coils_request_starting_address;
  _res = plc4c_spi_write_unsigned_short(writeBuffer, 16, startingAddress);
  if(_res != OK) {
    return _res;
  }
  ...
  // Simple Field (quantity)
  uint16_t quantity = _message->modbus_pdu_write_multiple_coils_request_quantity;
  _res = plc4c_spi_write_unsigned_short(writeBuffer, 16, quantity);
  if(_res != OK) {
    return _res;
  }
  ...
  // Implicit Field (byteCount) (Used for parsing, but its value is not stored as it's implicitly given by the objects content)
  uint8_t byteCount = plc4c_spi_evaluation_helper_count(_message->modbus_pdu_write_multiple_coils_request_value);
  _res = plc4c_spi_write_unsigned_byte(writeBuffer, 8, byteCount);
  if(_res != OK) {
    return _res;
  }
  ...
  // Simple Field (startingAddress)
  uint16_t startingAddress = _message->modbus_pdu_write_multiple_coils_response_starting_address;
  _res = plc4c_spi_write_unsigned_short(writeBuffer, 16, startingAddress);
  if(_res != OK) {
    return _res;
  }
  ...
  // Simple Field (quantity)
  uint16_t quantity = _message->modbus_pdu_write_multiple_coils_response_quantity;
  _res = plc4c_spi_write_unsigned_short(writeBuffer, 16, quantity);
  if(_res != OK) {
    return _res;
  }
  ...
  // Simple Field (startingAddress)
  uint16_t startingAddress = _message->modbus_pdu_read_input_registers_request_starting_address;
  _res = plc4c_spi_write_unsigned_short(writeBuffer, 16, startingAddress);
  if(_res != OK) {
    return _res;
  }
  ...
  // Simple Field (quantity)
  uint16_t quantity = _message->modbus_pdu_read_input_registers_request_quantity;
  _res = plc4c_spi_write_unsigned_short(writeBuffer, 16, quantity);
  if(_res != OK) {
    return _res;
  }
  ...
  // Implicit Field (byteCount) (Used for parsing, but its value is not stored as it's implicitly given by the objects content)
  uint8_t byteCount = plc4c_spi_evaluation_helper_count(_message->modbus_pdu_read_input_registers_response_value);
  _res = plc4c_spi_write_unsigned_byte(writeBuffer, 8, byteCount);
  if(_res != OK) {
    return _res;
  }
  ...
  // Simple Field (startingAddress)
  uint16_t startingAddress = _message->modbus_pdu_read_holding_registers_request_starting_address;
  _res = plc4c_spi_write_unsigned_short(writeBuffer, 16, startingAddress);
  if(_res != OK) {
    return _res;
  }
  ...
  // Simple Field (quantity)
  uint16_t quantity = _message->modbus_pdu_read_holding_registers_request_quantity;
  _res = plc4c_spi_write_unsigned_short(writeBuffer, 16, quantity);
  if(_res != OK) {
    return _res;
  }
  ...
  // Implicit Field (byteCount) (Used for parsing, but its value is not stored as it's implicitly given by the objects content)
  uint8_t byteCount = plc4c_spi_evaluation_helper_count(_message->modbus_pdu_read_holding_registers_response_value);
  _res = plc4c_spi_write_unsigned_byte(writeBuffer, 8, byteCount);
  if(_res != OK) {
    return _res;
  }
  ...
  // Simple Field (address)
  uint16_t address = _message->modbus_pdu_write_single_register_request_address;
  _res = plc4c_spi_write_unsigned_short(writeBuffer, 16, address);
  if(_res != OK) {
    return _res;
  }
  ...
  // Simple Field (value)
  uint16_t value = _message->modbus_pdu_write_single_register_request_value;
  _res = plc4c_spi_write_unsigned_short(writeBuffer, 16, value);
  if(_res != OK) {
    return _res;
  }
  ...
  // Simple Field (address)
  uint16_t address = _message->modbus_pdu_write_single_register_response_address;
  _res = plc4c_spi_write_unsigned_short(writeBuffer, 16, address);
  if(_res != OK) {
    return _res;
  }
  ...
  // Simple Field (value)
  uint16_t value = _message->modbus_pdu_write_single_register_response_value;
  _res = plc4c_spi_write_unsigned_short(writeBuffer, 16, value);
  if(_res != OK) {
    return _res;
  }
  ...
  // Simple Field (startingAddress)
  uint16_t startingAddress = _message->modbus_pdu_write_multiple_holding_registers_request_starting_address;
  _res = plc4c_spi_write_unsigned_short(writeBuffer, 16, startingAddress);
  if(_res != OK) {
    return _res;
  }
  ...
  // Simple Field (quantity)
  uint16_t quantity = _message->modbus_pdu_write_multiple_holding_registers_request_quantity;
  _res = plc4c_spi_write_unsigned_short(writeBuffer, 16, quantity);
  if(_res != OK) {
    return _res;
  }
  ...
  // Implicit Field (byteCount) (Used for parsing, but its value is not stored as it's implicitly given by the objects content)
  uint8_t byteCount = plc4c_spi_evaluation_helper_count(_message->modbus_pdu_write_multiple_holding_registers_request_value);
  _res = plc4c_spi_write_unsigned_byte(writeBuffer, 8, byteCount);
  if(_res != OK) {
    return _res;
  }
  ...
  // Simple Field (startingAddress)
  uint16_t startingAddress = _message->modbus_pdu_write_multiple_holding_registers_response_starting_address;
  _res = plc4c_spi_write_unsigned_short(writeBuffer, 16, startingAddress);
  if(_res != OK) {
    return _res;
  }
  ...
  // Simple Field (quantity)
  uint16_t quantity = _message->modbus_pdu_write_multiple_holding_registers_response_quantity;
  _res = plc4c_spi_write_unsigned_short(writeBuffer, 16, quantity);
  if(_res != OK) {
    return _res;
  }
  ...
  // Simple Field (readStartingAddress)
  uint16_t readStartingAddress = _message->modbus_pdu_read_write_multiple_holding_registers_request_read_starting_address;
  _res = plc4c_spi_write_unsigned_short(writeBuffer, 16, readStartingAddress);
  if(_res != OK) {
    return _res;
  }

  // Simple Field (readQuantity)
  uint16_t readQuantity = _message->modbus_pdu_read_write_multiple_holding_registers_request_read_quantity;
  _res = plc4c_spi_write_unsigned_short(writeBuffer, 16, readQuantity);
  if(_res != OK) {
    return _res;
  }

  // Simple Field (writeStartingAddress)
  uint16_t writeStartingAddress = _message->modbus_pdu_read_write_multiple_holding_registers_request_write_starting_address;
  _res = plc4c_spi_write_unsigned_short(writeBuffer, 16, writeStartingAddress);
  if(_res != OK) {
    return _res;
  }

  // Simple Field (writeQuantity)
  uint16_t writeQuantity = _message->modbus_pdu_read_write_multiple_holding_registers_request_write_quantity;
  _res = plc4c_spi_write_unsigned_short(writeBuffer, 16, writeQuantity);
  if(_res != OK) {
    return _res;
  }

  // Implicit Field (byteCount) (Used for parsing, but its value is not stored as it's implicitly given by the objects content)
  uint8_t byteCount = plc4c_spi_evaluation_helper_count(_message->modbus_pdu_read_write_multiple_holding_registers_request_value);
  _res = plc4c_spi_write_unsigned_byte(writeBuffer, 8, byteCount);
  if(_res != OK) {
    return _res;
  }
  ...
  // Implicit Field (byteCount) (Used for parsing, but its value is not stored as it's implicitly given by the objects content)
  uint8_t byteCount = plc4c_spi_evaluation_helper_count(_message->modbus_pdu_read_write_multiple_holding_registers_response_value);
  _res = plc4c_spi_write_unsigned_byte(writeBuffer, 8, byteCount);
  if(_res != OK) {
    return _res;
  }
  ...
  // Simple Field (referenceAddress)
  uint16_t referenceAddress = _message->modbus_pdu_mask_write_holding_register_request_reference_address;
  _res = plc4c_spi_write_unsigned_short(writeBuffer, 16, referenceAddress);
  if(_res != OK) {
    return _res;
  }

  // Simple Field (andMask)
  uint16_t andMask = _message->modbus_pdu_mask_write_holding_register_request_and_mask;
  _res = plc4c_spi_write_unsigned_short(writeBuffer, 16, andMask);
  if(_res != OK) {
    return _res;
  }

  // Simple Field (orMask)
  uint16_t orMask = _message->modbus_pdu_mask_write_holding_register_request_or_mask;
  _res = plc4c_spi_write_unsigned_short(writeBuffer, 16, orMask);
  if(_res != OK) {
    return _res;
  }
  ...
  // Simple Field (referenceAddress)
  uint16_t referenceAddress = _message->modbus_pdu_mask_write_holding_register_response_reference_address;
  _res = plc4c_spi_write_unsigned_short(writeBuffer, 16, referenceAddress);
  if(_res != OK) {
    return _res;
  }
  ...
  // Simple Field (andMask)
  uint16_t andMask = _message->modbus_pdu_mask_write_holding_register_response_and_mask;
  _res = plc4c_spi_write_unsigned_short(writeBuffer, 16, andMask);
  if(_res != OK) {
    return _res;
  }
  ...
  // Simple Field (orMask)
  uint16_t orMask = _message->modbus_pdu_mask_write_holding_register_response_or_mask;
  _res = plc4c_spi_write_unsigned_short(writeBuffer, 16, orMask);
  if(_res != OK) {
    return _res;
  }
  ...
  // Simple Field (fifoPointerAddress)
  uint16_t fifoPointerAddress = _message->modbus_pdu_read_fifo_queue_request_fifo_pointer_address;
  _res = plc4c_spi_write_unsigned_short(writeBuffer, 16, fifoPointerAddress);
  if(_res != OK) {
    return _res;
  }
  ...
  // Implicit Field (byteCount) (Used for parsing, but its value is not stored as it's implicitly given by the objects content)
  uint16_t byteCount = (((plc4c_spi_evaluation_helper_count(_message->modbus_pdu_read_fifo_queue_response_fifo_value)) * (2))) + (2);
  _res = plc4c_spi_write_unsigned_short(writeBuffer, 16, byteCount);
  if(_res != OK) {
    return _res;
  }

  // Implicit Field (fifoCount) (Used for parsing, but its value is not stored as it's implicitly given by the objects content)
  uint16_t fifoCount = (((plc4c_spi_evaluation_helper_count(_message->modbus_pdu_read_fifo_queue_response_fifo_value)) * (2))) / (2);
  _res = plc4c_spi_write_unsigned_short(writeBuffer, 16, fifoCount);
  if(_res != OK) {
    return _res;
  }
  ...
  // Implicit Field (byteCount) (Used for parsing, but its value is not stored as it's implicitly given by the objects content)
  uint8_t byteCount = plc4c_spi_evaluation_helper_array_size_in_bytes(_message->modbus_pdu_read_file_record_request_items);
  _res = plc4c_spi_write_unsigned_byte(writeBuffer, 8, byteCount);
  if(_res != OK) {
    return _res;
  }
  ...
  // Implicit Field (byteCount) (Used for parsing, but its value is not stored as it's implicitly given by the objects content)
  uint8_t byteCount = plc4c_spi_evaluation_helper_array_size_in_bytes(_message->modbus_pdu_read_file_record_response_items);
  _res = plc4c_spi_write_unsigned_byte(writeBuffer, 8, byteCount);
  if(_res != OK) {
    return _res;
  }
  ...
  // Implicit Field (byteCount) (Used for parsing, but its value is not stored as it's implicitly given by the objects content)
  uint8_t byteCount = plc4c_spi_evaluation_helper_array_size_in_bytes(_message->modbus_pdu_write_file_record_request_items);
  _res = plc4c_spi_write_unsigned_byte(writeBuffer, 8, byteCount);
  if(_res != OK) {
    return _res;
  }
  ...
  // Implicit Field (byteCount) (Used for parsing, but its value is not stored as it's implicitly given by the objects content)
  uint8_t byteCount = plc4c_spi_evaluation_helper_array_size_in_bytes(_message->modbus_pdu_write_file_record_response_items);
  _res = plc4c_spi_write_unsigned_byte(writeBuffer, 8, byteCount);
  if(_res != OK) {
    return _res;
  }
  ...
  // Simple Field (value)
  uint8_t value = _message->modbus_pdu_read_exception_status_response_value;
  ...
  // Simple Field (subFunction)
  uint16_t subFunction = _message->modbus_pdu_diagnostic_request_sub_function;
  _res = plc4c_spi_write_unsigned_short(writeBuffer, 16, subFunction);
  if(_res != OK) {
    return _res;
  }

  // Simple Field (data)
  uint16_t data = _message->modbus_pdu_diagnostic_request_data;
  _res = plc4c_spi_write_unsigned_short(writeBuffer, 16, data);
  if(_res != OK) {
    return _res;
  }
  ...
  // Simple Field (subFunction)
  uint16_t subFunction = _message->modbus_pdu_diagnostic_response_sub_function;
  _res = plc4c_spi_write_unsigned_short(writeBuffer, 16, subFunction);
  if(_res != OK) {
    return _res;
  }
  ...
  // Simple Field (data)
  uint16_t data = _message->modbus_pdu_diagnostic_response_data;
  _res = plc4c_spi_write_unsigned_short(writeBuffer, 16, data);
  if(_res != OK) {
    return _res;
  }
  ...
  // Simple Field (status)
  uint16_t status = _message->modbus_pdu_get_com_event_counter_response_status;
  _res = plc4c_spi_write_unsigned_short(writeBuffer, 16, status);
  if(_res != OK) {
    return _res;
  }

  // Simple Field (eventCount)
  uint16_t eventCount = _message->modbus_pdu_get_com_event_counter_response_event_count;
  _res = plc4c_spi_write_unsigned_short(writeBuffer, 16, eventCount);
  if(_res != OK) {
    return _res;
  }
  ...
  // Implicit Field (byteCount) (Used for parsing, but its value is not stored as it's implicitly given by the objects content)
  uint8_t byteCount = (plc4c_spi_evaluation_helper_count(_message->modbus_pdu_get_com_event_log_response_events)) + (6);
  _res = plc4c_spi_write_unsigned_byte(writeBuffer, 8, byteCount);
  if(_res != OK) {
    return _res;
  }
  ...
  // Simple Field (status)
  uint16_t status = _message->modbus_pdu_get_com_event_log_response_status;
  _res = plc4c_spi_write_unsigned_short(writeBuffer, 16, status);
  if(_res != OK) {
    return _res;
  }
  ...
  // Simple Field (eventCount)
  uint16_t eventCount = _message->modbus_pdu_get_com_event_log_response_event_count;
  _res = plc4c_spi_write_unsigned_short(writeBuffer, 16, eventCount);
  if(_res != OK) {
    return _res;
  }
  ...
  // Simple Field (messageCount)
  uint16_t messageCount = _message->modbus_pdu_get_com_event_log_response_message_count;
  _res = plc4c_spi_write_unsigned_short(writeBuffer, 16, messageCount);
  if(_res != OK) {
    return _res;
  }
  ...
  // Implicit Field (byteCount) (Used for parsing, but its value is not stored as it's implicitly given by the objects content)
  uint8_t byteCount = plc4c_spi_evaluation_helper_count(_message->modbus_pdu_report_server_id_response_value);
  _res = plc4c_spi_write_unsigned_byte(writeBuffer, 8, byteCount);
  if(_res != OK) {
    return _res;
  }

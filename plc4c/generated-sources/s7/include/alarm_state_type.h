...
#ifndef PLC4C_S7_READ_WRITE_ALARM_STATE_TYPE_H_
#define PLC4C_S7_READ_WRITE_ALARM_STATE_TYPE_H_
...
enum plc4c_s7_read_write_alarm_state_type {
  plc4c_s7_read_write_alarm_state_type_SCAN_ABORT = 0x00,
  plc4c_s7_read_write_alarm_state_type_SCAN_INITIATE = 0x01,
  plc4c_s7_read_write_alarm_state_type_ALARM_ABORT = 0x04,
  plc4c_s7_read_write_alarm_state_type_ALARM_INITIATE = 0x05,
  plc4c_s7_read_write_alarm_state_type_ALARM_S_ABORT = 0x08,
  plc4c_s7_read_write_alarm_state_type_ALARM_S_INITIATE = 0x09
};
typedef enum plc4c_s7_read_write_alarm_state_type plc4c_s7_read_write_alarm_state_type;

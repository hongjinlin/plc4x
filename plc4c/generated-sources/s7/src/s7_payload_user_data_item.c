...
plc4c_return_code plc4c_s7_read_write_s7_payload_user_data_item_serialize(plc4c_spi_write_buffer* writeBuffer, plc4c_s7_read_write_s7_payload_user_data_item* _message) {
  ...
  // Implicit Field (dataLength) (Used for parsing, but its value is not stored as it's implicitly given by the objects content)
  uint16_t dataLength = (plc4c_s7_read_write_s7_payload_user_data_item_length_in_bytes(_message)) - (4);
  _res = plc4c_spi_write_unsigned_short(writeBuffer, 16, dataLength);
  if(_res != OK) {
    return _res;
  }
  ...
  // Simple Field (EventId)
  uint16_t EventId = _message->s7_payload_diagnostic_message_event_id;
  _res = plc4c_spi_write_unsigned_short(writeBuffer, 16, EventId);
  if(_res != OK) {
    return _res;
  }

  // Simple Field (PriorityClass)
  uint8_t PriorityClass = _message->s7_payload_diagnostic_message_priority_class;
  _res = plc4c_spi_write_unsigned_byte(writeBuffer, 8, PriorityClass);
  if(_res != OK) {
    return _res;
  }

  // Simple Field (ObNumber)
  uint8_t ObNumber = _message->s7_payload_diagnostic_message_ob_number;
  _res = plc4c_spi_write_unsigned_byte(writeBuffer, 8, ObNumber);
  if(_res != OK) {
    return _res;
  }

  // Simple Field (DatId)
  uint16_t DatId = _message->s7_payload_diagnostic_message_dat_id;
  _res = plc4c_spi_write_unsigned_short(writeBuffer, 16, DatId);
  if(_res != OK) {
    return _res;
  }

  // Simple Field (Info1)
  uint16_t Info1 = _message->s7_payload_diagnostic_message_info1;
  _res = plc4c_spi_write_unsigned_short(writeBuffer, 16, Info1);
  if(_res != OK) {
    return _res;
  }

  // Simple Field (Info2)
  uint32_t Info2 = _message->s7_payload_diagnostic_message_info2;
  _res = plc4c_spi_write_unsigned_int(writeBuffer, 32, Info2);
  if(_res != OK) {
    return _res;
  }

  // Simple Field (TimeStamp)
  plc4c_s7_read_write_date_and_time* TimeStamp = _message->s7_payload_diagnostic_message_time_stamp;
  ...
  // Simple Field (alarmMessage)
  plc4c_s7_read_write_alarm_message_push_type* alarmMessage = _message->s7_payload_alarm8_alarm_message;
  _res = plc4c_s7_read_write_alarm_message_push_type_serialize(writeBuffer, alarmMessage);
  if(_res != OK) {
    return _res;
  }
  ...
  // Simple Field (alarmMessage)
  plc4c_s7_read_write_alarm_message_push_type* alarmMessage = _message->s7_payload_notify_alarm_message;
  _res = plc4c_s7_read_write_alarm_message_push_type_serialize(writeBuffer, alarmMessage);
  if(_res != OK) {
    return _res;
  }
  ...
  // Simple Field (alarmMessage)
  plc4c_s7_read_write_alarm_message_ack_push_type* alarmMessage = _message->s7_payload_alarm_ack_ind_alarm_message;
  _res = plc4c_s7_read_write_alarm_message_ack_push_type_serialize(writeBuffer, alarmMessage);
  if(_res != OK) {
    return _res;
  }
  ...
  // Simple Field (alarmMessage)
  plc4c_s7_read_write_alarm_message_push_type* alarmMessage = _message->s7_payload_alarm_sq_alarm_message;
  _res = plc4c_s7_read_write_alarm_message_push_type_serialize(writeBuffer, alarmMessage);
  if(_res != OK) {
    return _res;
  }
  ...
  // Simple Field (alarmMessage)
  plc4c_s7_read_write_alarm_message_push_type* alarmMessage = _message->s7_payload_alarm_s_alarm_message;
  _res = plc4c_s7_read_write_alarm_message_push_type_serialize(writeBuffer, alarmMessage);
  if(_res != OK) {
    return _res;
  }
  ...
  // Simple Field (alarmMessage)
  plc4c_s7_read_write_alarm_message_push_type* alarmMessage = _message->s7_payload_alarm_sc_alarm_message;
  _res = plc4c_s7_read_write_alarm_message_push_type_serialize(writeBuffer, alarmMessage);
  if(_res != OK) {
    return _res;
  }
  ...
  // Simple Field (alarmMessage)
  plc4c_s7_read_write_alarm_message_push_type* alarmMessage = _message->s7_payload_notify8_alarm_message;
  _res = plc4c_s7_read_write_alarm_message_push_type_serialize(writeBuffer, alarmMessage);
  if(_res != OK) {
    return _res;
  }
  ...
  // Simple Field (szlId)
  plc4c_s7_read_write_szl_id* szlId = _message->s7_payload_user_data_item_cpu_function_read_szl_request_szl_id;
  _res = plc4c_s7_read_write_szl_id_serialize(writeBuffer, szlId);
  if(_res != OK) {
    return _res;
  }

  // Simple Field (szlIndex)
  uint16_t szlIndex = _message->s7_payload_user_data_item_cpu_function_read_szl_request_szl_index;
  _res = plc4c_spi_write_unsigned_short(writeBuffer, 16, szlIndex);
  if(_res != OK) {
    return _res;
  }
  ...
  // Simple Field (szlId)
  plc4c_s7_read_write_szl_id* szlId = _message->s7_payload_user_data_item_cpu_function_read_szl_response_szl_id;
  _res = plc4c_s7_read_write_szl_id_serialize(writeBuffer, szlId);
  if(_res != OK) {
    return _res;
  }
  ...
  // Simple Field (szlIndex)
  uint16_t szlIndex = _message->s7_payload_user_data_item_cpu_function_read_szl_response_szl_index;
  _res = plc4c_spi_write_unsigned_short(writeBuffer, 16, szlIndex);
  if(_res != OK) {
    return _res;
  }
  ...
  // Const Field (szlItemLength)
  uint16_t szlItemLength = PLC4C_S7_READ_WRITE_S7_PAYLOAD_USER_DATA_ITEM_CPU_FUNCTION_READ_SZL_RESPONSE_SZL_ITEM_LENGTH();
  plc4c_spi_write_unsigned_short(writeBuffer, 16, szlItemLength);

  // Implicit Field (szlItemCount) (Used for parsing, but its value is not stored as it's implicitly given by the objects content)
  uint16_t szlItemCount = plc4c_spi_evaluation_helper_count(_message->s7_payload_user_data_item_cpu_function_read_szl_response_items);
  _res = plc4c_spi_write_unsigned_short(writeBuffer, 16, szlItemCount);
  if(_res != OK) {
    return _res;
  }
  ...
  // Simple Field (Subscription)
  uint8_t Subscription = _message->s7_payload_user_data_item_cpu_function_msg_subscription_subscription;
  _res = plc4c_spi_write_unsigned_byte(writeBuffer, 8, Subscription);
  if(_res != OK) {
    return _res;
  }
  ...
  // Simple Field (magicKey)
  char* magicKey = _message->s7_payload_user_data_item_cpu_function_msg_subscription_magic_key;
  _res = plc4c_spi_write_string(writeBuffer, 64, "UTF-8", magicKey);
  if(_res != OK) {
    return _res;
  }

  // Optional Field (Alarmtype)
  plc4c_s7_read_write_alarm_state_type* Alarmtype = _message->s7_payload_user_data_item_cpu_function_msg_subscription_alarmtype;
  if(_message->s7_payload_user_data_item_cpu_function_msg_subscription_alarmtype != NULL) {
    _res = plc4c_s7_read_write_alarm_state_type_serialize(writeBuffer, Alarmtype);
    if(_res != OK) {
      return _res;
    }
  }
  ...
  uint8_t* Reserve = _message->s7_payload_user_data_item_cpu_function_msg_subscription_reserve;
  if(_message->s7_payload_user_data_item_cpu_function_msg_subscription_reserve != NULL) {
    _res = plc4c_spi_write_unsigned_byte(writeBuffer, 8, *Reserve);
    if(_res != OK) {
      return _res;
    }
  }
  ...
  // Simple Field (result)
  uint8_t result = _message->s7_payload_user_data_item_cpu_function_msg_subscription_sys_response_result;
  _res = plc4c_spi_write_unsigned_byte(writeBuffer, 8, result);
  if(_res != OK) {
    return _res;
  }

  // Simple Field (reserved01)
  uint8_t reserved01 = _message->s7_payload_user_data_item_cpu_function_msg_subscription_sys_response_reserved01;
  _res = plc4c_spi_write_unsigned_byte(writeBuffer, 8, reserved01);
  if(_res != OK) {
    return _res;
  }
  ...
  // Simple Field (result)
  uint8_t result = _message->s7_payload_user_data_item_cpu_function_msg_subscription_alarm_response_result;
  _res = plc4c_spi_write_unsigned_byte(writeBuffer, 8, result);
  if(_res != OK) {
    return _res;
  }
  ...
  // Simple Field (reserved01)
  uint8_t reserved01 = _message->s7_payload_user_data_item_cpu_function_msg_subscription_alarm_response_reserved01;
  _res = plc4c_spi_write_unsigned_byte(writeBuffer, 8, reserved01);
  if(_res != OK) {
    return _res;
  }
  ...
  // Simple Field (alarmType)
  plc4c_s7_read_write_alarm_type alarmType = _message->s7_payload_user_data_item_cpu_function_msg_subscription_alarm_response_alarm_type;
  _res = plc4c_s7_read_write_alarm_type_serialize(writeBuffer, &alarmType);
  if(_res != OK) {
    return _res;
  }

  // Simple Field (reserved02)
  uint8_t reserved02 = _message->s7_payload_user_data_item_cpu_function_msg_subscription_alarm_response_reserved02;
  _res = plc4c_spi_write_unsigned_byte(writeBuffer, 8, reserved02);
  if(_res != OK) {
    return _res;
  }

  // Simple Field (reserved03)
  uint8_t reserved03 = _message->s7_payload_user_data_item_cpu_function_msg_subscription_alarm_response_reserved03;
  _res = plc4c_spi_write_unsigned_byte(writeBuffer, 8, reserved03);
  if(_res != OK) {
    return _res;
  }
  ...
  // Simple Field (functionId)
  uint8_t functionId = _message->s7_payload_user_data_item_cpu_function_alarm_ack_function_id;
  ...
  // Implicit Field (numberOfObjects) (Used for parsing, but its value is not stored as it's implicitly given by the objects content)
  uint8_t numberOfObjects = plc4c_spi_evaluation_helper_count(_message->s7_payload_user_data_item_cpu_function_alarm_ack_message_objects);
  ...
  // Simple Field (functionId)
  uint8_t functionId = _message->s7_payload_user_data_item_cpu_function_alarm_ack_response_function_id;
  _res = plc4c_spi_write_unsigned_byte(writeBuffer, 8, functionId);
  if(_res != OK) {
    return _res;
  }
  ...
  // Implicit Field (numberOfObjects) (Used for parsing, but its value is not stored as it's implicitly given by the objects content)
  uint8_t numberOfObjects = plc4c_spi_evaluation_helper_count(_message->s7_payload_user_data_item_cpu_function_alarm_ack_response_message_objects);
  _res = plc4c_spi_write_unsigned_byte(writeBuffer, 8, numberOfObjects);
  if(_res != OK) {
    return _res;
  }
  ...
  // Const Field (functionId)
  uint8_t functionId = PLC4C_S7_READ_WRITE_S7_PAYLOAD_USER_DATA_ITEM_CPU_FUNCTION_ALARM_QUERY_FUNCTION_ID();
  plc4c_spi_write_unsigned_byte(writeBuffer, 8, functionId);

  // Const Field (numberMessageObj)
  uint8_t numberMessageObj = PLC4C_S7_READ_WRITE_S7_PAYLOAD_USER_DATA_ITEM_CPU_FUNCTION_ALARM_QUERY_NUMBER_MESSAGE_OBJ();
  plc4c_spi_write_unsigned_byte(writeBuffer, 8, numberMessageObj);

  // Const Field (variableSpec)
  uint8_t variableSpec = PLC4C_S7_READ_WRITE_S7_PAYLOAD_USER_DATA_ITEM_CPU_FUNCTION_ALARM_QUERY_VARIABLE_SPEC();
  plc4c_spi_write_unsigned_byte(writeBuffer, 8, variableSpec);

  // Const Field (length)
  uint8_t length = PLC4C_S7_READ_WRITE_S7_PAYLOAD_USER_DATA_ITEM_CPU_FUNCTION_ALARM_QUERY_LENGTH();
  plc4c_spi_write_unsigned_byte(writeBuffer, 8, length);

  // Simple Field (syntaxId)
  plc4c_s7_read_write_syntax_id_type syntaxId = _message->s7_payload_user_data_item_cpu_function_alarm_query_syntax_id;
  ...
  // Simple Field (queryType)
  plc4c_s7_read_write_query_type queryType = _message->s7_payload_user_data_item_cpu_function_alarm_query_query_type;
  _res = plc4c_s7_read_write_query_type_serialize(writeBuffer, &queryType);
  if(_res != OK) {
    return _res;
  }
  ...
  // Simple Field (alarmType)
  plc4c_s7_read_write_alarm_type alarmType = _message->s7_payload_user_data_item_cpu_function_alarm_query_alarm_type;
  _res = plc4c_s7_read_write_alarm_type_serialize(writeBuffer, &alarmType);
  if(_res != OK) {
    return _res;
  }
  ...
  // Const Field (functionId)
  uint8_t functionId = PLC4C_S7_READ_WRITE_S7_PAYLOAD_USER_DATA_ITEM_CPU_FUNCTION_ALARM_QUERY_RESPONSE_FUNCTION_ID();
  plc4c_spi_write_unsigned_byte(writeBuffer, 8, functionId);

  // Const Field (numberMessageObj)
  uint8_t numberMessageObj = PLC4C_S7_READ_WRITE_S7_PAYLOAD_USER_DATA_ITEM_CPU_FUNCTION_ALARM_QUERY_RESPONSE_NUMBER_MESSAGE_OBJ();
  plc4c_spi_write_unsigned_byte(writeBuffer, 8, numberMessageObj);

  // Simple Field (pudicfReturnCode)
  plc4c_s7_read_write_data_transport_error_code pudicfReturnCode = _message->s7_payload_user_data_item_cpu_function_alarm_query_response_pudicf_return_code;
  _res = plc4c_s7_read_write_data_transport_error_code_serialize(writeBuffer, &pudicfReturnCode);
  if(_res != OK) {
    return _res;
  }

  // Simple Field (pudicftransportSize)
  plc4c_s7_read_write_data_transport_size pudicftransportSize = _message->s7_payload_user_data_item_cpu_function_alarm_query_response_pudicftransport_size;
  _res = plc4c_s7_read_write_data_transport_size_serialize(writeBuffer, &pudicftransportSize);
  if(_res != OK) {
    return _res;
  }

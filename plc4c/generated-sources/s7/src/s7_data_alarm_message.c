...
plc4c_return_code plc4c_s7_read_write_s7_data_alarm_message_serialize(plc4c_spi_write_buffer* writeBuffer, plc4c_s7_read_write_s7_data_alarm_message* _message) {
  ...
  // Const Field (functionId)
  uint8_t functionId = PLC4C_S7_READ_WRITE_S7_DATA_ALARM_MESSAGE_FUNCTION_ID();
  plc4c_spi_write_unsigned_byte(writeBuffer, 8, functionId);

  // Const Field (numberMessageObj)
  uint8_t numberMessageObj = PLC4C_S7_READ_WRITE_S7_DATA_ALARM_MESSAGE_NUMBER_MESSAGE_OBJ();
  ...
  // Const Field (variableSpec)
  uint8_t variableSpec = PLC4C_S7_READ_WRITE_S7_MESSAGE_OBJECT_REQUEST_VARIABLE_SPEC();
  plc4c_spi_write_unsigned_byte(writeBuffer, 8, variableSpec);

  // Const Field (length)
  uint8_t length = PLC4C_S7_READ_WRITE_S7_MESSAGE_OBJECT_REQUEST_LENGTH();
  plc4c_spi_write_unsigned_byte(writeBuffer, 8, length);

  // Simple Field (syntaxId)
  plc4c_s7_read_write_syntax_id_type syntaxId = _message->s7_message_object_request_syntax_id;
  ...
  // Simple Field (queryType)
  plc4c_s7_read_write_query_type queryType = _message->s7_message_object_request_query_type;
  ...
  // Simple Field (alarmType)
  plc4c_s7_read_write_alarm_type alarmType = _message->s7_message_object_request_alarm_type;
  ...
  // Simple Field (returnCode)
  plc4c_s7_read_write_data_transport_error_code returnCode = _message->s7_message_object_response_return_code;
  ...
  // Simple Field (transportSize)
  plc4c_s7_read_write_data_transport_size transportSize = _message->s7_message_object_response_transport_size;

...
uint8_t plc4c_s7_read_write_alarm_type_get_value(plc4c_s7_read_write_alarm_type value) {
    switch(value) {
        case plc4c_s7_read_write_alarm_type_SCAN:
            return (uint8_t) 0x01;
        case plc4c_s7_read_write_alarm_type_ALARM_8:
            return (uint8_t) 0x02;
        case plc4c_s7_read_write_alarm_type_ALARM_S:
            return (uint8_t) 0x04;
    }
    return 0;
}
...
plc4c_return_code plc4c_s7_read_write_alarm_type_serialize(plc4c_spi_write_buffer* writeBuffer, plc4c_s7_read_write_alarm_type* _message) {
    ...
    uint8_t value = plc4c_s7_read_write_alarm_type_get_value(*_message);

...
// Constant values.
static const uint8_t PLC4C_S7_READ_WRITE_ALARM_MESSAGE_ACK_OBJECT_PUSH_TYPE_VARIABLE_SPEC_const = 0x12;
uint8_t PLC4C_S7_READ_WRITE_ALARM_MESSAGE_ACK_OBJECT_PUSH_TYPE_VARIABLE_SPEC() {
  return PLC4C_S7_READ_WRITE_ALARM_MESSAGE_ACK_OBJECT_PUSH_TYPE_VARIABLE_SPEC_const;
}
...
plc4c_return_code plc4c_s7_read_write_alarm_message_ack_object_push_type_parse(plc4c_spi_read_buffer* readBuffer, plc4c_s7_read_write_alarm_message_ack_object_push_type** _message) {
  ...
  (*_message) = malloc(sizeof(plc4c_s7_read_write_alarm_message_ack_object_push_type));
  if(*_message == NULL) {
    return NO_MEMORY;
  }
  ...
  if(variableSpec != PLC4C_S7_READ_WRITE_ALARM_MESSAGE_ACK_OBJECT_PUSH_TYPE_VARIABLE_SPEC()) {
    return PARSE_ERROR;
    // throw new ParseException("Expected constant value " + PLC4C_S7_READ_WRITE_ALARM_MESSAGE_ACK_OBJECT_PUSH_TYPE_VARIABLE_SPEC + " but got " + variableSpec);
  }
...
plc4c_return_code plc4c_s7_read_write_alarm_message_ack_object_push_type_serialize(plc4c_spi_write_buffer* writeBuffer, plc4c_s7_read_write_alarm_message_ack_object_push_type* _message) {
  ...
  // Const Field (variableSpec)
  uint8_t variableSpec = PLC4C_S7_READ_WRITE_ALARM_MESSAGE_ACK_OBJECT_PUSH_TYPE_VARIABLE_SPEC();

...
#define DEFAULT_CONNECTION_TEST_STRING "plc4c:tcp://127.0.0.1:59837"
...
int main(int argc, char** argv) {
  ...
  plc4c_driver *plc4x_driver = plc4c_driver_plc4x_create();
  result = plc4c_system_add_driver(system, plc4x_driver);
